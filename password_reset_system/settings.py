"""
Django settings for password_reset_system project.
...
SECRET_KEY = 'django-insecure-bba@n#h$^^v%agg2peru@^zwhlmsx@p49q#lfwv=%@ieuu#i2v'
...
ROOT_URLCONF = 'password_reset_system.urls'
...
WSGI_APPLICATION = 'password_reset_system.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'password_reset_db',
        'USER': 'postgres',  # Default admin user
        'PASSWORD': os.getenv('DB_PASSWORD'),  # Set during install
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
